...
**本项目相比于常规实现，更改了菜品缓存方式，原实现采用“有修改即清空全部缓存“的方式，本项目采用了“标记脏位，仅在查看时清空对应的缓存内容”的方式，减少了对缓存的清空次数以及不必要的清空**
...
5. 克隆项目到本地 `git clone https://github.com/Hello-Liu0618/sky-take-out0.git `
...
7. 在 [resources](./sky-server/src/main/resources/) 目录下新建 `application-env.yml` 文件，写入以下配置
   ...
   项目地址：https://github.com/Hello-Liu0618/sky-take-out0
